...
It is not a framework and it was not designed. Every script here was **extracted from a live fleet** of 36 deployed repositories ([orangecat.ch](https://orangecat.ch), [loki.orangecat.ch](https://loki.orangecat.ch), [datacat.orangecat.ch](https://datacat.orangecat.ch), and 30+ more) after the third time the same problem was solved twice. The comments carry the outage reports that shaped them.
